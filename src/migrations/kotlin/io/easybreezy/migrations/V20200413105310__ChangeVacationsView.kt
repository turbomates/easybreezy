...
class V20200413105310__ChangeVacationsView : BaseJavaMigration() {
    override fun migrate(context: Context) {
        ...
        context.execute("""
            ...
            (SELECT count(*) /*absence days without holidays*/
                ...
                WHERE a.is_approved = true and a.user_id = ul.user_id and extract('ISODOW' FROM a_day) < 6 and a.started_at >= ul.started_at and a.ended_at <= ul.ended_at
            )
            -
